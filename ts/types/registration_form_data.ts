...
export function extractRegistrationFormData(form: HTMLFormElement): RegistrationFormData {
    ...
    return {
        ...
        italianMunicipalityId: data.get("italian_municipality_id") as string ?? undefined,
        streetAddress: data.get("street_address") as string,
        houseNumber: data.get("houseNumber") as string,
        cap: data.get("cap") as string,
        locality: data.get("locality") as string ?? undefined,
        additionalInfo: data.get("additional_info") as string ?? undefined,
